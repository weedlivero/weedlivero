...
const adminLinks = [
  ...
  { href: '/admin/products/new', label: 'Prodotti', icon: '📦' },
  { href: '/admin/categories', label: 'Categorie', icon: '📂' },
  { href: '/admin/brands', label: 'Brand', icon: '🏷️' },
  ...
  return (
    <AdminGuard>
      ...
      <main className="mx-auto grid max-w-7xl gap-6 px-5 pb-24 pt-6 lg:grid-cols-[260px_1fr] lg:pb-10">
        <aside className="hidden rounded-3xl bg-white p-4 shadow-sm lg:block lg:sticky lg:top-6 lg:h-fit">
